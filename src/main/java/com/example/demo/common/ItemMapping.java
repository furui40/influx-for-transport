...
public class ItemMapping {
    public static final Map<String, String> WEIGHT_COLUMN_MAPPING = new LinkedHashMap<>();
    public static final Map<String, String> WEATHER_COLUMN_MAPPING = new LinkedHashMap<>();
    ...
    static {
        // 列名映射
        // 动态称重
        WEIGHT_COLUMN_MAPPING.put("编号", "id");
        WEIGHT_COLUMN_MAPPING.put("时间", "timestamp");
        WEIGHT_COLUMN_MAPPING.put("总重KG", "weightKg");
        WEIGHT_COLUMN_MAPPING.put("车长", "vehicleLength");
        WEIGHT_COLUMN_MAPPING.put("车道", "lane");
        WEIGHT_COLUMN_MAPPING.put("轴数", "axleCount");
        WEIGHT_COLUMN_MAPPING.put("速度", "speed");
        WEIGHT_COLUMN_MAPPING.put("温度", "temperature");
        WEIGHT_COLUMN_MAPPING.put("方向", "direction");
        WEIGHT_COLUMN_MAPPING.put("跨道", "crossLane");
        WEIGHT_COLUMN_MAPPING.put("类型", "type");
        WEIGHT_COLUMN_MAPPING.put("轴重1", "axleWeight1");
        WEIGHT_COLUMN_MAPPING.put("轴重2", "axleWeight2");
        WEIGHT_COLUMN_MAPPING.put("轴重3", "axleWeight3");
        WEIGHT_COLUMN_MAPPING.put("轴重4", "axleWeight4");
        WEIGHT_COLUMN_MAPPING.put("轴重5", "axleWeight5");
        WEIGHT_COLUMN_MAPPING.put("轴重6", "axleWeight6");
        WEIGHT_COLUMN_MAPPING.put("轴距1", "wheelbase1");
        WEIGHT_COLUMN_MAPPING.put("轴距2", "wheelbase2");
        WEIGHT_COLUMN_MAPPING.put("轴距3", "wheelbase3");
        WEIGHT_COLUMN_MAPPING.put("轴距4", "wheelbase4");
        WEIGHT_COLUMN_MAPPING.put("轴距5", "wheelbase5");
        WEIGHT_COLUMN_MAPPING.put("车型编号", "vehicleTypeCode");
        WEIGHT_COLUMN_MAPPING.put("车型", "vehicleType");
        WEIGHT_COLUMN_MAPPING.put("轴1KN", "axle1Kn");
        WEIGHT_COLUMN_MAPPING.put("轴2KN", "axle2Kn");
        WEIGHT_COLUMN_MAPPING.put("轴3KN", "axle3Kn");
        WEIGHT_COLUMN_MAPPING.put("偏移", "offset");

        // 气象数据
        WEATHER_COLUMN_MAPPING.put("时间", "timestamp");
        WEATHER_COLUMN_MAPPING.put("环温(℃)", "ambientTemperature");
        WEATHER_COLUMN_MAPPING.put("温度1(℃)", "temperature1");
        WEATHER_COLUMN_MAPPING.put("露点温度(℃)", "dewPointTemperature");
        WEATHER_COLUMN_MAPPING.put("环湿(%RH)", "ambientHumidity");
        WEATHER_COLUMN_MAPPING.put("气压(hPa)", "airPressure");
        WEATHER_COLUMN_MAPPING.put("总辐射1瞬时(W/㎡)", "totalRadiation1Instant");
        WEATHER_COLUMN_MAPPING.put("紫外辐射瞬时(W/㎡)", "UVRadiationInstant");
        WEATHER_COLUMN_MAPPING.put("风向(°)", "windDirection");
        WEATHER_COLUMN_MAPPING.put("瞬时风速(m/s)", "instantWindSpeed");
        WEATHER_COLUMN_MAPPING.put("2分钟风速(m/s)", "windSpeed2Min");
        WEATHER_COLUMN_MAPPING.put("10分钟风速(m/s)", "windSpeed10Min");
        WEATHER_COLUMN_MAPPING.put("雨量间隔累计(mm)", "rainfallIntervalAccumulated");
        WEATHER_COLUMN_MAPPING.put("雨量日累计(mm)", "rainfallDailyAccumulated");
        WEATHER_COLUMN_MAPPING.put("总辐射1日累计(MJ/㎡)", "totalRadiation1DailyAccumulated");
        WEATHER_COLUMN_MAPPING.put("紫外辐射日累计(MJ/㎡)", "UVRadiationDailyAccumulated");
        WEATHER_COLUMN_MAPPING.put("光照度(KLux)", "illuminance");
        WEATHER_COLUMN_MAPPING.put("电量(V)", "voltage");
