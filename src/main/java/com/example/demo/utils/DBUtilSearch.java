...
public class DBUtilSearch {
    ...
    public static List<MonitorData> BaseQuery(InfluxDBClient client, List<String> fields,
        ...
        // 构建 Flux 查询语句
        StringBuilder flux = new StringBuilder("from(bucket: \"")
                .append(influxDbBucket).append("\") ")
...
//        System.out.println("查询用时： " + (System.currentTimeMillis()-time1) + "ms");
    ...
    public static List<MonitorData> BaseQuery2(InfluxDBClient client, List<String> fields,
                                              Long startTime, Long stopTime, Long samplingInterval) {
        // 构建 Flux 查询语句
        StringBuilder flux = new StringBuilder("from(bucket: \"")
                .append(influxDbBucket2).append("\") ")
                .append("|> range(start: ").append(startTime)
                .append(", stop: ").append(stopTime).append(") ")
                .append("|> filter(fn: (r) => ");
